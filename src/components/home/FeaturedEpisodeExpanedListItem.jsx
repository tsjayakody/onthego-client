...
function FeaturedEpisodeExpanedListItem({
    episodeCover,
    episodeName,
    episodeCreator,
}) {
...
FeaturedEpisodeExpanedListItem.defualtProps = {
    episodeCover: '',
    episodeName: '',
    episodeCreator: '',
}

FeaturedEpisodeExpanedListItem.propTypes = {
    episodeCover: PropTypes.string,
    episodeName: PropTypes.string,
    episodeCreator: PropTypes.string,
}

export default FeaturedEpisodeExpanedListItem