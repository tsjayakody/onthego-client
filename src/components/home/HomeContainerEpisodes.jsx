...
function HomeContainerEpisodes({ bannerImage, bannerTitle, bannerCreator }) {
    return (
        <div className='flex flex-col justify-start h-164 w-119 bg-#282246 md:bg-transparent mr-[31px] md:h-183 md:w-138'>
            <img src={bannerImage} className='h-119 w-119 md:pt-0 md:h-138 md:w-138' alt="" />
