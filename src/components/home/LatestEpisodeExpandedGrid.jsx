...
import LatestEpisodeExpanedListItem from './LatestEpisodeExpanedListItem';

function LatestEpisodeExpandedGrid() {
  return (
            ...
            <div className='flex flex-col h-screen'>
                ...
                <div className='flex-1 overflow-y-auto'>
                    <div className='flex flex-col ml-[61px] mt-[71px]'>
                        {/* category title here */}
                        <p className='text-#FFFFFF text-18px mb-[15px]'>Latest Episodes</p>
                        {/* grid here */}
...
export default LatestEpisodeExpandedGrid