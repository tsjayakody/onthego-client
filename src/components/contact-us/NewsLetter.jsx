...
function NewsLetter() {
    ...
    return (
        <div className='bg-#282246 pt-[30px] pb-[19px] pl-[26px] mr-[33px] flex-col justify-start'>
            <h3 className='text-#FFFFFF text-[20px] md:text-[26px]'>Sign Up for our newsletter</h3>
            <div className='md:flex md:items-center'>
                <p className='text-#666666 text-[10px] md:text-[15px] md:max-w-[454px] text-justify'>Get notified about updates and be the first to get early access to new episodes.</p>
