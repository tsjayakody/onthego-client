            ...
            <form className='pt-[12px] pb-[50px]'>
                    ...
                    <div className='flex-col'>
                        <div className="mb-[13px] lg:mr-[20px]">
                            <input
                                ...
                                value={name}
                                className=" bg-[#2F2566] md:bg-[#110E1F] border border-[#453598] text-white placeholder-[#666666] text-[14px] rounded-lg focus:ring-blue-500 focus:border-blue-500  w-full lg:w-[386px] lg:h-[32.52px] h-[40px] p-2.5 "
                ...
                <div className='mb-[6px] md:mb-[17px] md:max-w-[792px] '>
                    <div className='mb-[10px]'>
                        <textarea
                            ...
                            cols="10"
                            rows="4"
                            className='bg-#2F2566 md:bg-[#110E1F] border border-[#453598] text-white placeholder-[#666666] text-[14px] rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5'>
                        </textarea>
                    </div>
                ...
                <div className='w-full flex justify-end md:pr-[42px]'>
                    <button
                        ...
                        onMouseDown={event}
                        type="submit"
                        className="h-[45px] w-[180px] px-[34px] py-[9px] text-white bg-[#282246] text-[14px] text-center">
                        Send Episodes
                    </button>
                </div>
            </form>
